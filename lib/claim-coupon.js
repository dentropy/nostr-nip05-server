...
export async function claim_coupon(MyDDSchema, ddroot, req, res, nostr_content_json) {
    ...
    try {
        ...
        try {
            check_from_did = await MyDDSchema.rxdb[
            ...
            check_from_did_balance = check_from_did[0]._data.balance
        } catch (error) {
            return({
                "status": "error",
        ...
        // Get token_state to create transaction
        try {
        ...
        try {
            ...
            // console.log("check_from_did[0].nonce")
            // console.log(check_from_did[0]._data.content.nonce)
            // console.log("get_token_state[0]._data.content.token_transaction_count")
            // console.log(get_token_state[0]._data.content.token_transaction_count)
            ...
            token_content_json = {
                ...
                "body": {
                    ...
                    "value": 1,
                    "did_nonce": check_from_did[0]._data.content.nonce + 1,
                    "token_nonce": get_token_state[0]._data.content.token_transaction_count,
                    "memo": "coupon_redeemed",
                    "operation_data" : {}
                }
            }
            ...
            console.log("dd_token_signedEvent")
        ...
        try {
            ...
            console.log("dd_token_result_coupon")
            console.log(dd_token_result)
            return ({
                "status": "success",
